<%@ Page Title="" Language="C#" MasterPageFile="~/mMenu.master" AutoEventWireup="true" CodeBehind="ReconcileReport.aspx.cs" Inherits="ECX.Attendance.UI.Reports.ReconcileReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width: 640px">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Label2" runat="server" Text="Report Type"></asp:Label></td>            
        </tr>
        <tr>
            ...
            <td>
                ...
                <asp:DropDownList ID="ddlReportType" runat="server" Enabled="false" AutoPostBack="false" OnSelectedIndexChanged="ddlReportType_SelectedIndexChanged">
                    <asp:ListItem Value="1">Traded with No Attendance</asp:ListItem>
                    <asp:ListItem Value="2">Attendance but not Traded</asp:ListItem>
                </asp:DropDownList>
            </td>
